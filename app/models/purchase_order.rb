class PurchaseOrder < ActiveRecord::Base
  ...
  attr_accessible :budget, :email, :date, :delivery_address, :number, :raised_by, :supplier_name, :your_company_name, :line_items_attributes, :status, :conversation_key, :phone_number, :note
